      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 lg:gap-24">
        ...
        <div class="space-y-6">
          ...
          <div class="flex flex-row xl:flex-row gap-3 items-start w-full mt-4 md:mt-6 flex-wrap">
            <a
              ...
              class="w-full max-w-[220px] h-[52px] flex items-center justify-start gap-3 shrink-0 px-5 border border-caramel text-caramel font-sans font-semibold transition-all duration-300 ease-in-out hover:bg-espresso hover:text-cream"
            >
              ...
              <span class="text-xs tracking-wider uppercase text-left leading-tight">Скачать в App Store</span>
            </a>
            ...
            >
              ...
              <span class="text-xs tracking-wider uppercase text-left leading-tight">Скачать в Google Play</span>
            </a>
          </div>
        </div>
        ...
        <div class="space-y-6">
          ...
          <div class="pt-2 space-y-4">
            ...
            <ul class="space-y-2">
              <li
                ...
                :key="index"
                class="text-chocolate/60 font-sans font-normal text-xs leading-relaxed"
              >
                {{ location.address }}
          ...
          <div class="flex items-center space-x-4 pt-6">
            ...
            <p class="text-chocolate/70 font-sans font-normal text-xs tracking-wider uppercase leading-relaxed">
