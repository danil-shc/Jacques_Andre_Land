        ...
        <div class="space-y-6">
          ...
          <div class="flex flex-row xl:flex-row gap-3 items-start w-full mt-4 md:mt-6 flex-wrap">
            <a
              ...
              class="w-full max-w-[220px] h-[52px] flex items-center justify-center gap-2 shrink-0 px-4 border border-caramel text-caramel font-sans font-semibold transition-all duration-300 ease-in-out hover:bg-espresso hover:text-cream"
            >
              <svg
              ...
              <span class="text-xs tracking-wider uppercase">Скачать в App Store</span>
            </a>
            ...
            >
              ...
              <span class="text-xs tracking-wider uppercase">Скачать в Google Play</span>
            </a>
          </div>
        </div>
