...
<template>
  <section class="w-full bg-cream py-16 md:py-24">
    <div class="max-w-[1920px] mx-auto px-4 md:px-8 space-y-16">
      <!-- Section Header -->
      <div class="text-center">
        <h2 class="font-serif text-3xl md:text-4xl lg:text-5xl text-chocolate tracking-widest uppercase">
          НАШИ ОБЫЧАИ
        </h2>
      </div>
      ...
      <div class="flex flex-col lg:grid lg:grid-cols-2 gap-0">
        ...
        <div class="bg-espresso min-h-[450px] md:min-h-[500px] lg:h-[500px] flex flex-col justify-center px-6 py-12 md:px-12 md:py-16 lg:px-16 lg:py-12 space-y-6 md:space-y-8">
          <!-- Title -->
          <h3 class="font-serif text-2xl md:text-3xl lg:text-4xl text-cream tracking-wide leading-tight">
            В СЕРДЦЕ АДЫГЕИ
          </h3>

          <!-- Paragraph 1 -->
          <p class="font-sans text-sm md:text-base lg:text-base text-cream/90 leading-relaxed">
          ...
          <div class="pt-4">
            <button 
              class="border border-cream text-cream font-sans text-xs tracking-widest uppercase px-6 py-3 hover:bg-cream hover:text-chocolate transition-all duration-300 ease-in-out cursor-pointer"
            >
              УЗНАТЬ ИСТОРИЮ
            </button>
          </div>
      ...
      <div class="max-w-[1600px] mx-auto px-4 md:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          ...
          <div class="text-center space-y-3 px-4">
            <h4 class="font-sans text-xs tracking-widest uppercase text-caramel font-semibold">
              ДОСТАВКА
            </h4>
            <p class="font-sans text-sm text-chocolate/80 leading-relaxed">
