export const menuProducts = [
  {
    ...
    description: 'Премиальный слоёный круассан с лососем, сливочным сыром и свежей зеленью',
    price: 420,
    category: 'Выпечка',
  ...
  },
  {
    ...
    description: 'Воздушный круассан с домашним соусом песто, свежими томатами и моцареллой',
    price: 350,
    category: 'Выпечка',
  ...
  },
  {
    id: 3,
    name: 'Торт "Амели"',
    description: 'Изысканный авторский торт с нежным кремом, мягким бисквитом и вкусной начинкой',
    price: 2800,
    category: 'Десерты',
    image: 'tort_ameli',
  },
  {
    ...
    description: 'Многослойный торт с карамелью, шоколадным муссом и хрустящим пралине',
    price: 3200,
    category: 'Десерты',
    image: 'tort_caramel',
  },
